//
//  ArticleVenteViewController.swift
//  ProjetIOS
//
...
class ArticleVenteViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let myapiurl = "http://localhost:1337/article/vendre"
